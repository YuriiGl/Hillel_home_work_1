...
class AllTests(unittest.TestCase):
    ...
    def test_temperature_calc(self):
        ...
        self.assertEqual(lesson_7_2.temperature('K', 0), (-273.15, 0.0, -459.67))
        self.assertEqual(lesson_7_2.temperature('F', 0), (-57.6, 255.37222222222223, 0.0))

    def test_email(self):
        self.assertEqual(lesson_11_2.hide_email('somebody_email@gmail.com'), 'somebody_em***@**il@gmail.com')

    def test_num_phone(self):
        self.assertEqual(lesson_15_16_2.format_phone('063-999-99-99'), '(+38) 063 999-99-99')
        self.assertEqual(lesson_15_16_2.format_phone('063 999-99-99'), '(+38) 063 999-99-99')
        self.assertEqual(lesson_15_16_2.format_phone('063-99999-99'), '(+38) 063 999-99-99')
        self.assertEqual(lesson_15_16_2.format_phone('+38063999-99-99'), '(+38) 063 999-99-99')
        self.assertEqual(lesson_15_16_2.format_phone('380639999999'), '(+38) 063 999-99-99')
